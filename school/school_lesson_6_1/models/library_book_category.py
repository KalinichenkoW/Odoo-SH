...
class LibraryBookCategory(models.Model):
    ...
    parent_id = fields.Many2one(comodel_name='library.book.category', index=True, ondelete='cascade')
    parent_path = fields.Char(index=True, )
    child_id = fields.One2many(comodel_name='library.book.category',  inverse_name='parent_id', string='Child Categories')
